...
import { tool as dnsRecordsLookup } from './dns-records-lookup';
...
export const toolsByCategory: ToolCategory[] = [
  {
    name: 'Crypto',
    components: [tokenGenerator, hashText, bcrypt, uuidGenerator, ulidGenerator, cypher, bip39, hmacGenerator, rsaKeyPairGenerator, passwordStrengthAnalyser, pdfSignatureChecker, x509CertificateDecoder],
  },
  {
    name: 'Converter',
    components: [
  ...
  {
    name: 'Network',
    components: [ipv4SubnetCalculator, ipv4AddressConverter, ipv4RangeExpander, macAddressLookup, macAddressGenerator, ipv6UlaGenerator, dnsRecordsLookup],
  },
  {
    name: 'Math',
